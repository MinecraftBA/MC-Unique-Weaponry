...
public final class ModItemRecipeProvider extends RecipeProvider {
	...
	public ModItemRecipeProvider(HolderLookup.Provider lookupProvider, RecipeOutput recipeOutput) {
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        protected RecipeProvider createRecipeProvider(HolderLookup.Provider lookupProvider, RecipeOutput recipeOutput) {
            return new ModItemRecipeProvider(lookupProvider, recipeOutput);
        }

        @Override
        public String getName() {
            return "Unique Weaponry Drop Recipes";
        }
    }
	...
	protected void buildRecipes() {
		...
		this.shaped(RecipeCategory.COMBAT, GrenadeItems.FLASH_GRENADE.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, GrenadeItems.IGNITE_GRENADE.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, GrenadeItems.FREEZE_GRENADE.get(), 1)
	    	.define('C', Items.ICE)
	    	.define('G', Items.GUNPOWDER)
	    	.define('R', Items.REDSTONE)
	    	.define('I', Items.IRON_INGOT)
		...
		this.shaped(RecipeCategory.COMBAT, GrenadeItems.POISON_GRENADE.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, GrenadeItems.LEVITATE_GRENADE.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, GunItems.WEBBER.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, BookItems.EVOKERS_TOME.get(), 1)
			.define('B', Items.BOOK)
		...
		this.shaped(RecipeCategory.COMBAT, StaffItems.SKULLCASTER.get(), 1)
		...
		this.shaped(RecipeCategory.COMBAT, StaffItems.INFERNAL_SCEPTER.get(), 1)
